    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                ...
                <li class="nav-item"><a href="#new-student" class="nav-link" data-toggle="tab"><i class="icon-plus2"></i> Create New Student</a></li>
            </ul>
                                    ...
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left">
                                                @if(Qs::userIsTeamSA())
                                                    <a href="{{ route('students.edit', $student->id) }}" class="dropdown-item"><i class="icon-pencil"></i> Edit</a>
                                                @endif
                                                @if(Qs::userIsSuperAdmin())
                                                    <a id="{{ $student->id }}" onclick="confirmDelete(this.id)" href="#" class="dropdown-item"><i class="icon-trash"></i> Delete</a>
                                                    <form method="post" id="item-delete-{{ $student->id }}" action="{{ route('students.destroy', $student->id) }}" class="hidden">@csrf @method('delete')</form>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input name="date_of_birth" value="{{ old('date_of_birth') }}" required type="text" class="form-control date-pick" placeholder="Select Date...">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input value="{{ old('mobile') }}" required type="text" name="mobile" class="form-control" placeholder="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input value="{{ old('kin_full_name') }}" required type="text" name="kin_full_name" placeholder="Full Name" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input value="{{ old('kin_phone') }}" required type="text" name="kin_mobile" class="form-control" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Telephone:</label>
                                <input value="{{ old('kin_tel') }}" type="text" name="kin_telephone" class="form-control" placeholder="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input value="{{ old('admission_year') }}" required type="year" name="admission_year" class="form-control" placeholder="Admission Year">
                            </div>
                        </div>
                    </div>
