...
{{--                                    <td>{{ $programs->qualification->name }}</td>--}}
{{--                                </tr>--}}
{{--                                <tr>--}}
{{--                                    <td class="font-weight-bold text-justify">Department</td>--}}
{{--                                    <td>{{ $programs->department->name }}</td>--}}
{{--                                </tr>--}}
                                <tr>
                                    ...
                                    <div class="col-md-6">
                                        <form class="ajax-store" method="post" action="{{ route('program-courses.store') }}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <select required data-placeholder="Select Course" multiple class="form-control select-search" name="course_id[]" id="courses">
                                                            <option value=""></option>
