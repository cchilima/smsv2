            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Mobile: </label>
                            <input value="{{ $application->phone_number }}" type="text" name="phone_number" class="form-control"
                                placeholder="">
                        </div>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select data-placeholder="Select Country" class="select-search form-control"
                                ...
                                @foreach ($countries as $country)
                                    <option value="{{ $country->id }}" {{ $application->country_id === $country->id ? 'selected' : '' }}>{{ $country->country }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select data-placeholder="Select Town" class="select-search form-control"
                                name="town_id" id="town_id">
                                <option disabled selected></option>
                             @foreach ($towns as $town)
                            <option value="{{ $town->id }}" {{ $application->town_id === $town->id ? 'selected' : '' }}>{{ $town->name }}</option>
                        @endforeach 
                            </select>
                        </div>
                    </div>
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <select data-placeholder="Select Program" class="select-search form-control"
                            name="program_id" id="program_id">
                            <option value=""></option>
                            @foreach ($programs as $program)
                                <option value="{{ $program->id }}" {{ $application->program_id === $program->id ? 'selected' : '' }}> {{$program->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <select data-placeholder="Select Academic Period Intake"
                            ...
                            @foreach ($periodIntakes as $intake)
                                <option value="{{ $intake->id }}" {{ $application->academic_period_intake_id === $intake->id ? 'selected' : '' }}>{{ $intake->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <select data-placeholder="Select Study Mode" class="select-search form-control"
                            ...
                            @foreach ($studyModes as $mode)
                                <option value="{{ $mode->id }}" {{ $application->study_mode_id === $mode->id ? 'selected' : '' }}>{{ $mode->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input value="" accept="pdf" type="file"
                                name="attachment" class="form-input-styled" data-fouc>
                            <span class="form-text text-muted">Accepted Files : pdf
                                500KB</span>
                        </div>
                    </div>
                </div>
