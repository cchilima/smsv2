            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Address: </label>
                            <input value="{{ $application->address }}" type="text" name="address" class="form-control"
                                placeholder="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select data-placeholder="Select Country" class="select-search form-control" name="country_id"
                                id="country_id">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select data-placeholder="Select Province" class="select-search form-control" name="province_id"
                                id="province_id">
