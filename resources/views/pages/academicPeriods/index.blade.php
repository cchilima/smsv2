    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="all-open">
                                        ...
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-left">
                                                    @if (Qs::userIsTeamSA())
                                                        <a href="{{ route('academic-periods.edit', $period->id) }}"
                                                            class="dropdown-item"><i class="icon-pencil"></i> Edit</a>
                                                    @endif
                                                    @if (Qs::userIsTeamSA())
                                                        <a href="{{ route('academic-periods.show', $period->id) }}"
                                                            class="dropdown-item"><i class="icon-eye"></i> Show</a>
                                                    @endif
                                                    @if (Qs::userIsTeamSA())
                                                        <a href="{{ route('academic-period-management.index', ['ac' => $period->id]) }}"
                                                            class="dropdown-item"><i class="icon-paperplane"></i> Manage</a>
                                                    @endif
                                                    @if (Qs::userIsSuperAdmin())
                                                        ...
                                                        <form method="post" id="item-delete-{{ $period->id }}"
                                                            action="{{ route('academic-periods.destroy', $period->id) }}"
                ...
                <div class="tab-pane fade show" id="all-closed">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select required data-placeholder="Select type" class="form-control select-search"
                                            name="period_type_id" id="period-type">
                                            <option value=""></option>
