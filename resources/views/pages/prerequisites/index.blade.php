                                        ...
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-left">
                                                    @if(Qs::userIsTeamSA())
                                                    <a href="{{ route('prerequisites.edit', Qs::hash($c->id)) }}" class="dropdown-item"><i class="icon-pencil"></i> Edit</a>
                                                   @endif
                                                        @if(Qs::userIsSuperAdmin())
                                                    <a id="{{ $c->pid }}" onclick="confirmDelete(this.id)" href="#" class="dropdown-item"><i class="icon-trash"></i> Delete</a>
                                                    <form method="post" id="item-delete-{{ $c->id }}" action="{{ route('prerequisites.destroy',  Qs::hash($c->id)) }}" class="hidden">@csrf @method('delete')</form>
                                                        @endif
                        ...
                        <div class="col-md-6">
                            <form class="ajax-store" method="post" action="{{ route('prerequisites.store') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select required data-placeholder="Select Course" class="form-control select-search" name="course_id" id="courses">
                                            <option value=""></option>
