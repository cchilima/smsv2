    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#all-classes" class="nav-link active" data-toggle="tab">Manage announcement</a></li>
                <li class="nav-item"><a href="#new-class" class="nav-link" data-toggle="tab"><i class="icon-plus2"></i> Create New Announcement</a></li>
            </ul>
                                        ...
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-left">
                                                    @if(Qs::userIsTeamSA())
                                                    <a href="{{ route('announcements.edit', $a->id) }}" class="dropdown-item"><i class="icon-pencil"></i> Edit</a>
                                                   @endif
                                                        @if(Qs::userIsTeamSA())
                                                            <a href="{{route('announcement.fullview', $a->id)}}" class="dropdown-item"><i class="icon-eye"></i> Show</a>
                                                        @endif
                                                        @if(Qs::userIsSuperAdmin())
                                                    <a id="{{ $a->id }}" onclick="confirmDelete(this.id)" href="#" class="dropdown-item"><i class="icon-trash"></i> Delete</a>
                                                    <form method="post" id="item-delete-{{ $a->id }}" action="{{ route('announcements.destroy', $a->id) }}" class="hidden">@csrf @method('delete')</form>
                                                        @endif
                        ...
                        <div class="col-md-10">
                            <form class="ajax-store" method="post" action="{{ route('announcements.store')  }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input name="title" value="{{ old('title') }}" required type="text" class="form-control" placeholder="Title">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <textarea name="description" value="{{ old('description') }}" required type="text" class="form-control" placeholder="description"></textarea>
                                    </div>
                                </div>
