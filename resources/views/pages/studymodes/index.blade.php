                                        ...
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-left">
                                                    @if(true)
                                                    Edit
                                                    <a href="{{ route('study-modes.edit', $m->id) }}" class="dropdown-item"><i class="icon-pencil"></i> Edit</a>
                                                   @endif
                                                        @if(true)
                                                    Delete
                                                    <a id="{{ $m->id }}" onclick="confirmDelete(this.id)" href="#" class="dropdown-item"><i class="icon-trash"></i> Delete</a>
                                                    <form method="post" id="item-delete-{{ $m->id }}" action="{{ route('study-modes.destroy', $m->id) }}" class="hidden">@csrf @method('delete')</form>
                                                        @endif
