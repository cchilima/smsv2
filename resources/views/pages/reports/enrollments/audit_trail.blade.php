...
@section('page_title', 'Audit trail Report')
@section('content')
    @php
        use App\Helpers\Qs;
    @endphp
                        ...
                        <div class="col-md-12">
                            <form class="ajax-store-test" method="post" action="{{ route('transaction-results')  }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label class="col-lg-3 col-form-label font-weight-semibold">Current Level <span
                                                    class="text-danger">*</span></label>
                                            <div class="col-lg-9">
                                                <select name="instructor_id" class="form-control select-search" required>
                                                    <option
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label class="col-lg-3 col-form-label font-weight-semibold">Admission Status <span
                                                    class="text-danger">*</span></label>
                                            <div class="col-lg-9">
                                                <select name="instructor_id" class="form-control select-search" required>
                                                    <option
