...
@section('page_title', 'Failed Online Transactions')
@section('content')
    @php
        use App\Helpers\Qs;
    @endphp
    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Run reports to get a fully customized output for all failed online transactions.</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-left">
                                                    ...
                                                    @if(Qs::userIsSuperAdmin())
                                                        ...
                                                        <form method="post" id="item-delete-{{ $u->id }}" action="{{ route('students.destroy', $u->id) }}" class="hidden">@csrf @method('delete')</form>
                                                    @endif
