...
<li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['student.enrollments']) ? 'nav-item-expanded nav-item-open' : '' }} ">
    ...
    <ul class="nav nav-group-sub" data-submenu-title="Manage Academics">
        <li class="nav-item"><a href="{{ route('student.enrollments') }}" class="nav-link {{ in_array(Route::currentRouteName(), ['student.enrollments']) ? 'active' : '' }}">Download Registration Summary</a></li>
        <li class="nav-item"><a href="#" class="nav-link {{ in_array(Route::currentRouteName(), ['student_ca_results']) ? 'active' : '' }}">Download Exam slip</a></li>
        <li class="nav-item"><a href="#" class="nav-link {{ in_array(Route::currentRouteName(), ['student-exam_registration']) ? 'active' : '' }}">Download Transcript</a></li>
    </ul>
</li>
