<li
    ...
    <a href="#" class="nav-link"><i class="icon-pencil6"></i> <span> Examinations</span></a>
...
<li
    class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['student.enrollments']) ? 'nav-item-expanded nav-item-open' : '' }} ">
