...
<body>
    <div class="header" style="text-align:center;">
        <img class="logo" src="data:image/gif;base64,{{ $logo }}" alt=""
            style="
    ...
    <div class="w-full">
        ...
        @foreach ($academic['classes'] as $p)
            <div class="margin-top">
                <div class="">
                    <div class="col" style="font-weight: bold;">
                        <br><br>
                        <!-- <br><br> -->
                        <p>Class CODE: {!! strtoupper($p['class_code']) !!}</p>
                        <br>
                        <p>Class NAME: {!! strtoupper($p['class_name']) !!}</p>
                        <br>
