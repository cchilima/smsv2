        ...
        <div class="margin-top">
            <div class="">
                <div class="col" style="font-weight: bold;">
                    <br><br>
                    <!-- <br><br> -->
                    <p>PROGRAM NAME: {!! strtoupper($academic['program_name']) !!}</p>
                    <br>
            ...
            <table class="table table-bordered" style="width:100%;border:1px solid black;border-collapse:collapse;">
                <thead>
                    <tr>
                        ...
                        <th style="font-size: 12px; text-align:center;border: 1px solid black;" scope="col">GENDER
                        </th>
                        ...
                        <th style="font-size: 12px; text-align:center;border: 1px solid black;" scope="col">
                            PERCENTAGE</th>
                        <th style="font-size: 12px; text-align:center;border: 1px solid black;" scope="col">BALANCE
                        </th>
                    </tr>
                </thead>
                <tbody>
