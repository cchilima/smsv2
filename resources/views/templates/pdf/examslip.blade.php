...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="row">
      <table style="width:100%; border: 1px solid gray; padding-bottom: 20px;">
        <tr>
          ...
          <td><b>NAME:</b> {{ strtoupper($student->user->first_name) }} {{ strtoupper($student->user->middle_name) }} {{ strtoupper($student->user->last_name) }}</td>
    ...
    <p>Courses to be examined</p>
      ...
      <p>Signatories:</p>
              ...
              <table style="width:60%">
                ...
                <br>
                <br>
                <p>I {{ strtoupper($student->user->first_name) }} {{ strtoupper($student->user->middle_name) }} {{ strtoupper($student->user->last_name) }}, confirm that the information that has been presented is accurate and complete.</p>
    ...
    <ul><h5>Note:</h5>
      ...
      <li>Your Examination slip and Student Identification Card should be presented to the invigilator before writing the exams</li>
