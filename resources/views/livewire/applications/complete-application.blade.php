<div>
    <div class="container p-10">
        ...
        <div class="row">
            ...
            @if ($currentSection === 'next_of_kin')
                <div id="next_of_kin">
                    <div class="row">
                        <div class="input-field col m6 s12">
                            <input wire:model="nk_name" placeholder="Name" type="text" class="validate">
                        ...
                        <div class="row">
                            <div class="input-field col m6 s12">
                                <input wire:model="nk_email" placeholder="Email" type="email" class="validate">
                                <label class="active">Email</label>
                                @error('email')
                                    <div class="row">
                                        <div class="input-field col m6 s12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col m6 s12">
                                            <label class="active">Country</label>
                                            <select wire:model.live="kin_country_id"
                                                class="browser-default custom-select ">
                                                <option></option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col m6 s12">
                                            <label class="active">Province</label>
                                            <select wire:model.live="kin_province_id"
                                                class="browser-default custom-select ">
                                                <option></option>
        ...
        @if ($currentSection === 'results')
            <div id="results">
                ...
                <div class="row">
                    ...
                    <div class="input-field col m6 s12">
                        <input wire:model="grade" placeholder="Grade" type="number" pattern="[1-9]" class="validate">
        ...
        <a href="{{ route('application.my-applications', $this->applicant->id) }}" type="button"
