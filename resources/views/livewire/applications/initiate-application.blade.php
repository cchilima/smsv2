...
<div class="container p-10">
    <div >
        <div class="mb-5">
            <h6 >Let's begin - Supply NRC or passport.</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
                    ...
                    <form wire:submit.prevent="saveAndProceed" class="col s12">
                        <div class="row">
                            <div class="input-field col m12 s12">
                                ...
                                <input wire:model="nrc" id="nrc" maxlength="9" name="nrc" type="text" class="validate" placeholder="NRC">
                                @error('nrc')
                            ...
                            <div class="input-field col m12 s12">
                                ...
                                <input wire:model="passport" id="passport" name="passport" type="text" class="validate" placeholder="Passport">
                                @error('passport')
                                    <span class="red-text darken-4 error">{{ $message }}</span>
                                @enderror
                            </div>
