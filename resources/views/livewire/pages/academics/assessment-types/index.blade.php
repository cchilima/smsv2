...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="tab-content">
            <div wire:ignore class="tab-pane fade show active" id="all-assessments">
                <livewire:datatables.academics.assessments.types />
            </div>

            <div wire:ignore class="tab-pane fade" id="new-assessments">
                <div class="row">
                    <div class="col-md-6">
                        <form class="ajax-store" method="post" action="{{ route('assessments.store') }}">
                            ...
                            <div class="text-right">
                                <button wire:click.debounce.1000ms="refreshTable('AssessmentTypesTable')" id="ajax-btn"
