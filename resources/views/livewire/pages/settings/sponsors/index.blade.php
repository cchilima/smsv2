...
<div class="card">
    ...
    <div class="card-body">
        <ul wire:ignore class="nav nav-tabs nav-tabs-highlight">
            <li class="nav-item"><a href="#all-sponsors" class="nav-link active" data-toggle="tab">Manage Marital
                    Statuses</a></li>
        ...
        <div class="tab-content">
            ...
            <div wire:ignore class="tab-pane fade" id="new-sponsor">
                <div class="row">
                    <div class="col-md-6">
                        <form class="ajax-store mb-4" method="post" action="#">
                            @csrf
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input name="status" value="{{ old('status') }}" required type="text"
                                        class="form-control"
                                        placeholder="Single | Married | Separated | Divorced | Widowed">
                                </div>
                            </div>
