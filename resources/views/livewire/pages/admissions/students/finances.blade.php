        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div wire:ignore class="tab-content">
                    ...
                    <div wire:ignore class="tab-pane fade show" id="quotations">
                        ...
                        <h4 class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="mb-2 d-flex justify-content-end">
                                ...
                                <form class="ajax-store" method="post" action="{{ route('quotations.quotation') }}">
                                    ...
                                    @if (!($balancePercentage < 100) && !$studentQuotedForCurrentAcademicPeriod)
                                        <div class="text-left">
                                            <button wire:click.debounce.1000ms="refreshTable('StudentQuotationsTable')"
                                                wire:confirm="Are you sure you want to generate a quotation for the current academic period?"
