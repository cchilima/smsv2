...
class ExamResultsReviewBoard extends Component
{
    ...
    protected ClassAssessmentsRepo $classAsessmentRepo;
    ...
    {
        $this->classAsessmentRepo = app(ClassAssessmentsRepo::class);
    ...
    public function mount(Request $request)
    {
        ...
        $this->data['grades'] = $this->classAsessmentRepo->getGrades($level, $pid, $aid);
        ...
        $this->data['students'] = $this->classAsessmentRepo->total_students($level, $pid, $aid);
    }
